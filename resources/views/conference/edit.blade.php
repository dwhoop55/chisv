    ...
    <form action="{{ route('conference.update', $conference->key) }}" enctype="multipart/form-data" method="post">
        ...
        <div class="field">
            ...
            <div class="control">
                ...
                <simple-switch :input-name="'delete_icon'" :value="{{ old('delete_icon',false) ? "true" : "false" }}"
                    :enabled-text="'Delete Icon'" :disabled-text="''"></simple-switch>
                @else
                @endif
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                ...
                <simple-switch :input-name="'delete_image'" :value="{{ old('delete_image',false) ? "true" : "false" }}"
                    :enabled-text="'Delete Image'" :disabled-text="''"></simple-switch>
                @else
                @endif
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input required class="input" type="text" name="location" placeholder="Country, City"
                    class="@error('location') is-danger @enderror" value="{{ old('location', $conference->location) }}">
            </div>
            @error('location')
            <p class="help is-danger">{{ $message }}</p>
            @enderror
        ...
        <div class="field">
            ...
            <div class="control">
                <timezone-picker :input-name="'timezone_id'" :id="{{ old('timezone_id', $conference->timezone->id) }}"
                    :timezones="{{ $timezones }}">
                </timezone-picker>
            </div>
        </div>
        ...
        <div class="field is-horizontal">
            <div class="field-body">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <day-picker :value="'{{ old('end_date', $conference->end_date) }}'" :input-name="'end_date'">
                        </day-picker>
                    </div>
                    @error('end_date')
                    <p class="help is-danger">{{ $message }}</p>
