        ...
        <div class="field is-grouped">
            <div class="control is-expanded">
                ...
                <input required class="input" type="text" name="firstname"
                    class="@error('firstname') is-danger @enderror" value="{{ old('firstname', $user->firstname) }}">
            </div>
            @error('firstname')
            ...
            <div class="control is-expanded">
                ...
                <input required class="input" type="text" name="lastname" class="@error('lastname') is-danger @enderror"
